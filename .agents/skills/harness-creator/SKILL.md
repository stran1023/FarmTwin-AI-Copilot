...
description: >-
  Build, audit, and improve lightweight harnesses for AI coding agents: AGENTS.md/AGENTS.md,
...
|---|---|---|
| Instructions | `AGENTS.md` or `AGENTS.md` | Startup path, working rules, definition of done |
...
- `--agent-file AGENTS.md` for Codex-oriented projects.
